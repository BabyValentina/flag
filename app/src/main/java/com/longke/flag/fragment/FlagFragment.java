...
import com.longke.flag.adapter.MyFlagAdapter;
 ...
 */
public class FlagFragment extends Fragment implements PullLoadMoreRecyclerView.PullLoadMoreListener {
    ...
    private MyFlagAdapter mRecyclerViewAdapter;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mRecyclerViewAdapter = new MyFlagAdapter();
        mRecyclerViewAdapter.setOnItemClickListener(new MyFlagAdapter.OnItemClickListener() {
            @Override
